...
namespace GenerateAst
{
    class Program
    {
        ...
        {
            output.Enqueue($"public interface I{baseName}Visitor<T>");
            output.Enqueue("{");
        ...
        {
            // base class
            output.Enqueue($"public abstract class {baseName}");
            output.Enqueue("{");
        ...
        private static void DefineType(string baseName, string className, string fields)
        {
            ...
            output.Enqueue($"public class {className} : {baseName}");
            output.Enqueue("{");
        ...
        {
            var folder = Path.Combine(outputDirectory, "Parsing");
