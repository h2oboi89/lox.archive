...
namespace GenerateParseRules
{
    class Program
    {
        ...
        private static readonly List<RuleSpec> rules = new List<RuleSpec>
        {
            ...
            new RuleSpec(TokenType.BANG_EQUAL, null, null, "NONE"),
            new RuleSpec(TokenType.EQUAL, null, null, "NONE"),
            new RuleSpec(TokenType.EQUAL_EQUAL, null, null, "NONE"),
            new RuleSpec(TokenType.GREATER, null, null, "NONE"),
            new RuleSpec(TokenType.GREATER_EQUAL, null, null, "NONE"),
            new RuleSpec(TokenType.LESS, null, null, "NONE"),
            new RuleSpec(TokenType.LESS_EQUAL, null, null, "NONE"),
